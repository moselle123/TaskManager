  ...
  function loadPage() {
    ...
    for (var i = 0; i < modulesList.length; i++) {
        ...
        if (i % 2 === 0) {
            ...
            html += "<div class=\"border rounded p-2 me-5\" style=\"width: 25vw;\"  onclick=\"clickModule("+i+")\"><h6 class=\"text-center fw-bold\">" + modulesList[i].name + "</h6><div class=\"d-flex justify-content-evenly mt-3\"><div class=\"d-flex flex-column align-items-center\"><h6>" + modulesList[i].average + "%</h6><p>Average</p></div><div class=\"d-flex flex-column align-items-center text-success\"><h6>" + modulesList[i].achieved +"%</h6><p>Achieved</p></div><div class=\"d-flex flex-column align-items-center text-danger\"><h6>" + modulesList[i].completed +"%</h6><p>Complete</p></div></div><div class=\"progress-stacked mx-3\"><div class=\"progress\" role=\"progressbar\" aria-label=\"Achieved\" aria-valuenow=\"" + modulesList[i].achieved +"\"aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: " + modulesList[i].achieved + "%;\"><div class=\"progress-bar bg-success\"></div></div><div class=\"progress\" role=\"progressbar\" aria-label=\"Complete\" aria-valuenow=\"" + modulesList[i].completed + "\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: " + completedWidth +"%;\"><div class=\"progress-bar bg-danger\"></div></div></div></div>";
            if (i === modulesList.length - 1) {
                html += "</div>"; // Close the row if this is the last module
            }
        } else {
            var html = "<div class=\" border rounded p-2 me-5\" style=\"width: 25vw;\"  onclick=\"clickModule("+i+")\"><h6 class=\"text-center fw-bold\"><div>" + modulesList[i].name + "</h6><div class=\"d-flex justify-content-evenly mt-3\"><div class=\"d-flex flex-column align-items-center\"><h6>" + modulesList[i].average + "%</h6><p>Average</p></div><div class=\"d-flex flex-column align-items-center text-success\"><h6>" + modulesList[i].achieved +"%</h6><p>Achieved</p></div><div class=\"d-flex flex-column align-items-center text-danger\"><h6>" + modulesList[i].completed +"%</h6><p>Complete</p></div></div><div class=\"progress-stacked mx-3\"><div class=\"progress\" role=\"progressbar\" aria-label=\"Achieved\" aria-valuenow=\"" + modulesList[i].achieved +"\"aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: " + modulesList[i].achieved + "%;\"><div class=\"progress-bar bg-success\"></div></div><div class=\"progress\" role=\"progressbar\" aria-label=\"Complete\" aria-valuenow=\"" + modulesList[i].completed + "\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: " + completedWidth +"%;\"><div class=\"progress-bar bg-danger\"></div></div></div></div></div>";
        }
        fullHTML += html;
    }
